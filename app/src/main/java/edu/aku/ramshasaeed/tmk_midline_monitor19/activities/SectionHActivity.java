...
import edu.aku.ramshasaeed.tmk_midline_monitor19.databinding.ActivitySectionHBinding;
...
/*        sJ.put("tj08a", bi.tj08a.isChecked() ? "1" : "0");
    ...
    public boolean formValidation() {
        ...
        return ValidatorClasss.EmptyRadioButton(this, bi.tj13, bi.tj13b, bi.tj13m, getString(R.string.tj13) + getString(R.string.month));
