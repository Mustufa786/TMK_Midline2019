...
public class AndroidDatabaseManager extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitQuery.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("query", Query10);
                //pass the query to getd01ta method and get results
                alc2 = dbm.getd01ta(Query10);
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    ArrayList<Cursor> alc2 = dbm.getd01ta(Query2);
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        ArrayList<Cursor> aldropt = dbm.getd01ta(Query6);
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        ArrayList<Cursor> aldeletet = dbm.getd01ta(Query7);
                                                        ...
                                                        .setPositiveButton("Add",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        ArrayList<Cursor> altc = dbm.getd01ta(Query4);
    ...
    public void getcolumnnames() {
        ArrayList<Cursor> alc3 = dbm.getd01ta("PRAGMA table_info(" + indexInfo.table_name + ")");
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            if (spinner_value.equalsIgnoreCase("Update this row")) {
                                                ...
                                                //dbm.getd01ta(Query3);
                                                ArrayList<Cursor> aluc = dbm.getd01ta(Query3);
                                            ...
                                            if (spinner_value.equalsIgnoreCase("Delete this row")) {
                                                ...
                                                ArrayList<Cursor> aldc = dbm.getd01ta(Query5);
    ...
    public void refreshTable(int d) {
        ...
        if (d == 0) {
            ...
            ArrayList<Cursor> alc3 = dbm.getd01ta(Query8);
            c3 = alc3.get(0);
            //saving cursor to the static indexinfo class which can be resued by the other functions
