...
public class HandwashingContract {
    ...
    public HandwashingContract Sync(JSONObject jsonObject) throws JSONException {
    ...
    public HandwashingContract Hydrate(Cursor cursor) {
