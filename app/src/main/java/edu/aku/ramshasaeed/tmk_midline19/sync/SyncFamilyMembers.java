...
public class SyncFamilyMembers extends AsyncTask<Void, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            Toast.makeText(mContext, sSynced + " FamilyMember's synced." + (json.length() - sSynced) + " Errors: " + sSyncedError, Toast.LENGTH_SHORT).show();

            pd.setMessage(sSynced + " FamilyMember's synced." + (json.length() - sSynced) + " Errors: " + sSyncedError);
